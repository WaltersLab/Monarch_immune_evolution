...
with open(args.GFF_list, "r") as list: 
	for i in list:
		file = i.rstrip("\r\n")
		os.system("sbatch S4b_job_submission_FST_1202.sh " + file + " " + args.population + " 0f")   # run 0f 
		os.system("sbatch S4b_job_submission_FST_1202.sh " + file + " " + args.population + " 4f")   #run 4f 
